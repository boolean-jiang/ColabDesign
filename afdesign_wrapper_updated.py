...
def main():
    ...
    parser.add_argument("--out_name", help="filename of design PDB structure/FASTA file", type=str)
    ...
    model.save_pdb(f"{args.out_name}.pdb")

    with open(f"{args.out_name}.fasta", "w") as outfas: outfas.write(model.get_seqs())
